...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        ...
                        <h3>Selamat Datang Di Klinik Sehat</h3>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php">Sudah mempunyai Akun?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="No. HP *"  />
                                        </div>
                                        <div class="form-group">
    ...
    <!-- script agar bisa berpindah halaman dri login sbg pasien ke dokter dan admin -->
