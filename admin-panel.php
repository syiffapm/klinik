<!DOCTYPE html>
<!-- data untuk tabel dan form pada booking konsultasi -->
<?php 
include('func.php');  
include('newfunc.php');
...
if(isset($_POST['app-submit']))
{
  ...
  // pop up jika full booked dan tanggal sudah terlewat
...
if(isset($_GET['cancel']))
  ...
  // spesialisasi untuk dokter dari database
function get_specs(){
  $con=mysqli_connect("localhost","root","","myhmsdb");
...
#list-app{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home" style="color: #07c582;">Daftar Konsultasi</a>
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home" style="color: #07c582;">Riwayat konsultasi</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Riwayat Konsultasi</h2>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Rekam Medis</h2>
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Membuat Janji Konsultasi</h4></center><br>
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  ?> -->
                    ...
                    <div class="col-md-4">
                          <label for="spec">Spesialisai:</label>
                        </div>
                        <div class="col-md-8">
                          <select name="spec" class="form-control" id="spec">
                              <option value="" disabled selected>Pilih Spesialisai</option>
                              <?php 
                              display_specs();
                              ?>
                          </select>
              ...
              document.getElementById('doctor').onchange = function updateFees(e) {
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-4"><label>Jam Konsultasi</label></div>
                  <div class="col-md-8">
                    ...
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      ...
                      <option value="16:00:00">19:00 PM</option>
                      <option value="16:00:00">20:00 PM</option>
                    </select>
