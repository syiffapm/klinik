<!DOCTYPE html>
<!-- memanggil data konsultasi dan memasukkan data hasil konsultasi ke laman pasien dari database -->
<?php 
include('func1.php');
...
.btn-primary{
  ...
  <style type="text/css">
    button:hover{cursor:pointer; background-color: #07c582;}
    #inputbtn:hover{cursor:pointer; background-color: #07c582;}
  </style>
...
<!-- tampilan depan -->
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list" style="color: #07c582;">Dashboard</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home" style="color: #07c582;">Daftar Konsultasi</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <!-- hyperlink daftar konsultasi -->
                      <h4 class="StepTitle" style="margin-top: 5%;"> Lihat Daftar Konsultasi</h4>
                      <script>
                ...
                <tbody>
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      ...
                      <!-- dokter bisa mengcancel konsultasi -->
                     <td>
                        <?php if(($row['userStatus']==1) && ($row['doctorStatus']==1))  
                        { ?>
                        ...
                        <button class="btn btn-success">Diagnosa</button></a>
                        <?php } else {
